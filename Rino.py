...
class Parser:
    ...
    def statement(self):
        ...
        if res.error:
            ...
            self.current_tok.pos_start, self.current_tok.pos_end,
            "Expected 'return:' -> (more code), 'continue', 'exit', Numbers, Identifier, Variable (var), '+' / '-' operators, left or right parenthesis! "
            ))

        return res.success(self.expr())
...
class Interpreter:
    ...
    def visit_ForNode(self, node, context):
        ...
        while condition():
            ...
            if res.should_return() and res.loop_should_continue == False and res.loop_should_exit == False: return res

            if res.loop_should_continue:
                continue
            if res.loop_should_exit:
                break
